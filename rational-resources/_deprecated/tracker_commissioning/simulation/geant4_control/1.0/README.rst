   ...
   no output data file: ::
      ...
      $ LD_LIBRARY_PATH=$(pwd)/BuildProducts/lib:${LD_LIBRARY_PATH} \
        bxg4_production \
         ...
         --g4-manager-seed 0      \
         --shpf-seed 0            \
         --config "@falaise:snemo/tracker_commissioning/simulation/control/1.0/manager.conf" \
         --g4-macro "@falaise:snemo/tracker_commissioning/simulation/control/1.0/geant4_visualization.mac"
      Idle> /run/beamOn 10
      Idle> exit
