...
.. code:: sh
   ...
   $ bxvariant_inspector \
          ...
          --variant-config "@falaise:snemo/demonstrator/simulation/vertexes/4.2/variants/repository.conf" \
...
.. raw:: sh
   ...
   bxgenvtx_production \
	 ...
	 --datatools::resource-path "falaise@$(pwd)/BuildProducts/share/Falaise-3.x.x/resources" \
	 --load-dll Falaise \
	 --geometry-manager         "@falaise:snemo/demonstrator/geometry/4.1/manager.conf" \
	 --vertex-generator-manager "@falaise:snemo/demonstrator/simulation/vertexes/4.2/manager.conf" \
	 --variant-config           "@falaise:snemo/demonstrator/simulation/vertexes/4.2/variants/repository.conf" \
	 --variant-gui \
	 --list
