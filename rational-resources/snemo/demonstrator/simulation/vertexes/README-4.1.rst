...
.. code:: sh
   ...
   $ bxvariant_inspector \
          ...
          --variant-config "@falaise:snemo/demonstrator/simulation/vertexes/4.1/variants/repository.conf" \
...
.. raw:: sh
   ...
   bxgenvtx_production \
	 ...
	 --vertex-generator-manager "@falaise:snemo/demonstrator/simulation/vertexes/4.1/manager.conf" \
	 --variant-config           "@falaise:snemo/demonstrator/simulation/vertexes/4.1/variants/repository.conf" \
	 --variant-gui \
	 --list
