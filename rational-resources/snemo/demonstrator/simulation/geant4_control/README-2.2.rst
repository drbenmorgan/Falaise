...
.. code:: sh
   ...
   brewsh> bxvariant_inspector \
          ...
          --variant-config "@falaise:snemo/demonstrator/simulation/geant4_control/2.2/variants/repository.conf" \
...
.. raw:: sh
   ...
   brewsh> LD_LIBRARY_PATH="$(pwd)/BuildProducts/lib:${LD_LIBRARY_PATH}" \
     ...
     --load-dll Falaise \
     --config @falaise:snemo/demonstrator/simulation/geant4_control/2.2/manager.conf \
...
.. raw:: sh
   ...
   brewsh> LD_LIBRARY_PATH="$(pwd)/BuildProducts/lib:${LD_LIBRARY_PATH}" \
     ...
     --interactive \
     --g4-visu \
     --g4-macro "@falaise:snemo/demonstrator/simulation/geant4_control/2.2/visu/visu_0.mac"
..
