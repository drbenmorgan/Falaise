...
struct manager_parameters {
  ...
  std::string output_data_bank_label;  //!< Name of the data bank for the bank
                                       //!output format
  ...
  std::string output_profiles_activation_rule;  //!< The rule to activate Monte
                                                //!Carlo simulation output
                                                //!profiles
  bool forbid_private_hits;                     //!< Do not save 'private' MC hits at the end of
                                                //!the simulated event
  bool dont_save_no_sensitive_hit_events;       //!< Do not save 'no sensitive' MC
                                                //!hits
