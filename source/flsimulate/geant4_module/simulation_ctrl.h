...
/** Object that hosts control parameters and data structures
 * (thread/mutex/condition) for a multi-threaded running of the G4 simulation
 * manager (simulation module)
 */
