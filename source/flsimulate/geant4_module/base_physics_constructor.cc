...
bool base_physics_constructor::is_initialized() const { return _initialized_; }
...
const std::string& base_physics_constructor::get_name() const { return _name_; }
...
const physics_list& base_physics_constructor::get_mother_physics_list() const {
  DT_THROW_IF(_mother_physics_list_ == 0, std::logic_error,
              "No mother physics list !");
...
void base_physics_constructor::ConstructParticle() { return; }

void base_physics_constructor::ConstructProcess() { return; }

void base_physics_constructor::initialize_standalone(
