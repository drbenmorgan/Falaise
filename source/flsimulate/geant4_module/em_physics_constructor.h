...
class em_physics_constructor : public base_physics_constructor {
 ...
 protected:
  ...
  void _setup_em_extra_models_configurator(
 ...
 private:
  // EM processes:
  std::string _em_model_;  ///< Electromagnetic model
                           ///("standard"/"livermore"/"penelope")

  // For gammas:
  bool _em_gamma_rayleigh_scattering_;  ///< Activation flag for gamma Rayleigh
                                        ///scattering (default=false)
  bool _em_gamma_photo_electric_;       ///< Activation flag for gamma photo electric
                                        ///effect (default=true)
  bool _em_gamma_compton_scattering_;   ///< Activation flag for gamma Compton
                                        ///scattering (default=true)
  bool _em_gamma_conversion_;           ///< Activation flag for gamma e+/e- pair
                                        ///conversion (default=true)
  bool _em_gamma_conversion_to_muons_;  ///< Activation flag for gamma muon pair
                                        ///conversion (default=false)
  bool _em_gamma_step_limiter_;         ///< Activation flag for gamma step limiter
                                        ///(default=false)
  bool _em_gamma_user_special_cuts_;    ///< Activation flag for gamma user
                                        ///special cuts (default=false)

  // For electron/positron:
  bool _em_electron_ionization_;           ///< Activation flag for electron/positron
                                           ///ionization (default=true)
  bool _em_electron_bremsstrahlung_;       ///< Activation flag for electron/positron
                                           ///bremsstrahlung (default=true)
  bool _em_electron_multiple_scattering_;  ///< Activation flag for
                                           ///electron/positron multiple
                                           ///scattering (default=true)
  bool _em_electron_ms_use_distance_to_boundary_;  ///< Activation flag for
                                                   ///electron/positron multiple
                                                   ///scattering special
                                                   ///algorithm near volume
                                                   ///boundary (default=true)
  double _em_electron_ms_range_factor_;            ///< Special factor for
                                                   ///electron/positron multiple
                                                   ///scattering (default=0.005)
  bool _em_positron_annihilation_;                 ///< Activation flag for positron
                                    ///annihilation (default=true)
  bool _em_electron_step_limiter_;       ///< Activation flag for electron/positron
                                         ///step limiter (default=true)
  bool _em_electron_user_special_cuts_;  ///< Activation flag for
  ...
  std::string _em_pixe_cross_section_model_;           ///< PIXE cross section mode
                                                       ///(default="Empirical")
  std::string _em_pixe_electron_cross_section_model_;  ///< PIXE electron cross
                                                       ///section model
                                                       ///(default="Livermore")
  std::map<std::string, region_deexcitation_type>
      _em_regions_deexcitation_;  ///< Dictionary of atomic deexcitation
                                  ///configuration for regions (default=empty)

  // For ions:
  bool _em_ion_multiple_scattering_;  ///< Activation flag for ion multiple
                                      ///scattering (default=true)
  bool _em_ion_ionization_;           ///< Activation flag for ion ionization
                                      ///(default=true)
  bool _em_ion_step_limiter_;         ///< Activation flag for ion step limiter
                                      ///(default=true)
  bool _em_ion_user_special_cuts_;    ///< Activation flag for ion user special
                                      ///cuts (default=false)

  // For muons:
  bool _em_muon_multiple_scattering_;  ///< Activation flag for muon multiple
                                       ///scattering (default=true)
  bool _em_muon_ionization_;           ///< Activation flag for muon ionization
                                       ///(default=true)
  bool _em_muon_bremsstrahlung_;       ///< Activation flag for muon bremsstrahlung
                                       ///(default=true)
  bool _em_muon_pair_production_;      ///< Activation flag for muon pair production
                                       ///(default=true)
  bool _em_muon_step_limiter_;         ///< Activation flag for muon step limiter
                                       ///(default=false)
  bool _em_muon_user_special_cuts_;    ///< Activation flag for muon user special
                                       ///cuts (default=false)

  // Others:
  bool _em_other_multiple_scattering_;  ///< Activation flag for other particle
                                        ///multiple scattering (default=true)
  bool _em_other_ionization_;           ///< Activation flag for other particle
                                        ///ionization (default=true)
  bool _em_other_step_limiter_;         ///< Activation flag for other particle step
                                        ///limiter (default=false)
  bool _em_other_user_special_cuts_;    ///< Activation flag for other particle
                                        ///user special cuts (default=false)

  bool _em_using_extra_models_;  ///< Activation flag for EM extra models
  ...
  /// Return the mutable reference to the internal private data, create it if
  /// not existing
