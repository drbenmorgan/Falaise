...
///
/// This class merges the computation of the equation of motion for (charged)
/// particles in an electromagnetic field. The field can be purely magnetic, or
/// a mix magnetic or electric field. The code is inspired by the following
/// official Geant4 classes:
///   * G4EqMagElectricField
///   * G4EqEMFieldWithSpin
///   * G4Mag_UsualEqRhs
///   * G4Mag_SpinEqRhs
/// and merges their functionalities into one signgle class (to much inheritance
/// in Geant4!) Support of spin/mag.field interaction still needs to be
/// developped particularly because it is needed to set the particle's magnetic
/// anomaly and today it is forced to be 0. The problem here is that only the
/// SetChargeMomentumMass method is available from the Geant4 library and it is
/// not possible to set the specific anomaly  that depends on the current
/// tracked particle.
class em_field_equation_of_motion : public G4EquationOfMotion,
 ...
 public:
  ...
  void EvaluateRhsGivenB(const G4double y_[], const G4double field_[6],
