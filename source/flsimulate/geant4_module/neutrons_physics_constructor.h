...
class neutrons_physics_constructor : public base_physics_constructor {
 ...
 private:
  ...
  bool _use_gammas_hadronic_process_;     //!< Flag to use hadronic process for
                                          //!gammas
  bool _use_electrons_hadronic_process_;  //!< Flag to use hadronic process for
                                          //!electrons
  bool _use_neutrons_inelastic_process_;  //!< Flag to use inelastic process for
                                          //!neutrons
  bool _use_neutrons_elastic_process_;    //!< Flag to use elastic process for
                                          //!neutrons
  bool _use_neutrons_capture_;            //!< Flag to use neutron capture
  bool _use_neutrons_fission_;            //!< Flag to use neutron fission
  bool _use_protons_inelastic_process_;   //!< Flag to use inelastic process for
                                          //!protons
  bool _use_protons_elastic_process_;     //!< Flag to use elastic process for
                                          //!protons
