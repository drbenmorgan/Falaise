...
// static
std::string em_field_g4_stuff::label_from_stepper(stepper_type s_) {
  switch (s_) {
...
// static
em_field_g4_stuff::stepper_type em_field_g4_stuff::stepper_from_label(
...
void em_field_g4_stuff::set_g4_electromagnetic_field(
    electromagnetic_field* ebfield_) {
  DT_THROW_IF(is_initialized(), std::logic_error,
              "Geant4 EM field stuff is already initialized !");
...
bool em_field_g4_stuff::is_initialized() const { return _initialized_; }
...
void em_field_g4_stuff::initialize(const datatools::properties& config_) {
  ...
  DT_THROW_IF(_b_field_ == 0 && _eb_field_ == 0, std::logic_error,
  ...
  if (config_.has_key("force_explicit_parameters")) {
    force_explicit_parameters =
        config_.fetch_boolean("force_explicit_parameters");
  }
  ...
  DT_THROW_IF(force_explicit_parameters &&
              ...
              std::logic_error,
              "Invalid min step value for field labelled '"
                  << get_g4_field_name() << "'!");
  ...
  DT_THROW_IF(force_explicit_parameters &&
              ...
              std::logic_error,
              "Invalid delta chord value for field labelled '"
                  << get_g4_field_name() << "'!");
  ...
  DT_THROW_IF(force_explicit_parameters &&
                  (!datatools::is_valid(_delta_intersection_) ||
                   _delta_intersection_ <= 0.0),
              std::logic_error,
              "Invalid delta intersection value for field labelled '"
                  << get_g4_field_name() << "'!");
  ...
  DT_THROW_IF(force_explicit_parameters &&
              ...
              std::logic_error,
              "Invalid eps min value for field labelled '"
                  << get_g4_field_name() << "'!");
  ...
  DT_THROW_IF(force_explicit_parameters &&
              ...
              std::logic_error,
              "Invalid eps max value for field labelled '"
                  << get_g4_field_name() << "'!");
...
void em_field_g4_stuff::_at_init() {
  ...
  if (_eb_field_) {
    em_field_equation_of_motion* eqom =
        new em_field_equation_of_motion(_eb_field_);
    ...
    // General EM field:
    if (with_spin) {
      DT_LOG_DEBUG(_logprio(), "Using 'G4EqEMFieldWithSpin' equation of
    motion..."); _equation_ = new G4EqEMFieldWithSpin(_eb_field_); } else {
      DT_LOG_DEBUG(_logprio(), "Using 'G4EqMagElectricField' equation of
    motion..."); _equation_ = new G4EqMagElectricField(_eb_field_);
    }
    */
  } else if (_b_field_) {
    em_field_equation_of_motion* eqom =
        new em_field_equation_of_motion(_b_field_);
    eqom->set_logging_priority(_logprio());
    eqom->set_with_spin(with_spin);
    ...
    if (with_spin) {
      ...
      DT_LOG_DEBUG(_logprio(), "Using 'G4Mag_UsualEqRhs' equation of
    motion..."); _equation_ = new G4Mag_UsualEqRhs(_b_field_);
    }
    */
  }
  DT_LOG_DEBUG(_logprio(),
               "Equation of motion is set at [@" << _equation_ << "]");
  ...
  if (allocate_stepper) {
    ...
    switch (_stepper_type_) {
      ...
      case STEPPER_EXACT_HELIX:
        ...
        _field_stepper_ =
            new G4ExactHelixStepper(dynamic_cast<G4Mag_EqRhs*>(_equation_));
        break;
      case STEPPER_HELIX_EXPLICIT_EULER:
        DT_THROW_IF(_eb_field_, std::logic_error,
                    "Stepper ["
                        ...
                        << "] cannot be used with a non-pure magnetic field!");
        _field_stepper_ =
            new G4HelixExplicitEuler(dynamic_cast<G4Mag_EqRhs*>(_equation_));
        break;
      case STEPPER_HELIX_HEUM:
        DT_THROW_IF(_eb_field_, std::logic_error,
                    "Stepper ["
                        ...
                        << "] cannot be used with a non-pure magnetic field!");
        _field_stepper_ =
            new G4HelixHeum(dynamic_cast<G4Mag_EqRhs*>(_equation_));
        break;
      case STEPPER_HELIX_IMPLICIT_EULER:
        DT_THROW_IF(_eb_field_, std::logic_error,
                    "Stepper ["
                        ...
                        << "] cannot be used with a non-pure magnetic field!");
        _field_stepper_ =
            new G4HelixImplicitEuler(dynamic_cast<G4Mag_EqRhs*>(_equation_));
        break;
      case STEPPER_HELIX_MIXED_EULER:
        DT_THROW_IF(_eb_field_, std::logic_error,
                    "Stepper ["
                        << _stepper_type_
                        << "] cannot be used with a non-pure magnetic field!");
        _field_stepper_ = new G4HelixMixedStepper(
            dynamic_cast<G4Mag_EqRhs*>(_equation_), ndata);
        break;
      case STEPPER_HELIX_SIMPLE_RUNGE:
        DT_THROW_IF(_eb_field_, std::logic_error,
                    "Stepper ["
                        ...
                        << "] cannot be used with a non-pure magnetic field!");
        _field_stepper_ =
            new G4HelixSimpleRunge(dynamic_cast<G4Mag_EqRhs*>(_equation_));
        break;
      default:
  ...
  DT_LOG_DEBUG(_logprio(), "Using integration driver minimum step = "
                               << min_step / CLHEP::mm << " [mm]");

  int driver_stat_verbosity = 1;
  _integration_driver_ = new G4MagInt_Driver(
      min_step, _field_stepper_, _field_stepper_->GetNumberOfVariables(),
...
double em_field_g4_stuff::get_min_step() const { return _min_step_; }
...
bool em_field_g4_stuff::is_spin() const { return _spin_; }
...
double em_field_g4_stuff::get_delta_chord() const { return _delta_chord_; }
...
double em_field_g4_stuff::get_eps_min() const { return _eps_min_; }
...
double em_field_g4_stuff::get_eps_max() const { return _eps_max_; }
...
void em_field_g4_stuff::tree_dump(std::ostream& out_, const std::string& title_,
  ...
  out_ << indent_ << datatools::i_tree_dumpable::tag
       << "Stepper type          : '" << label_from_stepper(_stepper_type_)
       << "'" << std::endl;

  out_ << indent_ << datatools::i_tree_dumpable::tag
       << "Minimal step          : " << _min_step_ / CLHEP::mm << " [mm]"
       << std::endl;

  out_ << indent_ << datatools::i_tree_dumpable::tag
       << "Delta chord           : " << _delta_chord_ / CLHEP::mm << " [mm]"
       << std::endl;

  out_ << indent_ << datatools::i_tree_dumpable::tag
       << "Delta one step        : " << _delta_one_step_ / CLHEP::mm << " [mm]"
       << std::endl;

  out_ << indent_ << datatools::i_tree_dumpable::tag
       << "Delta intersection    : " << _delta_intersection_ / CLHEP::mm
       << " [mm]" << std::endl;

  out_ << indent_ << datatools::i_tree_dumpable::tag
       << "Epsilon min           : " << _eps_min_ << std::endl;

  out_ << indent_ << datatools::i_tree_dumpable::tag
       << "Epsilon max           : " << _eps_max_ << std::endl;

  out_ << indent_ << datatools::i_tree_dumpable::tag
       << "Spin                  : " << _spin_ << std::endl;
  ...
  out_ << indent_ << datatools::i_tree_dumpable::tag
       << "Field propagator      : [@" << _field_propagator_ << "]"
       << std::endl;
