...
/// \brief Base class for G4-based physics constructor with factory registration
/// support
class base_physics_constructor : public G4VPhysicsConstructor,
 ...
 public:
  ...
  /// Initialization from a set of configuration properties and a dictionary of
 ...
 private:
  ...
  physics_list
      *_mother_physics_list_;  //!< Reference to the mother physics list
