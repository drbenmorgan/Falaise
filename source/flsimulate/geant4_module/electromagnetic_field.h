...
class electromagnetic_field :  // public G4MagneticField,
 ...
 private:
  ...
  const emfield::base_electromagnetic_field
      *_field_;                 //!< Handle to the electromagnetic field
  bool _field_check_pos_time_;  //!< Flag for checking position/time
  geomtools::vector_3d
      _standalone_constant_mag_field_;  //!< Standalone uniform magnetic field
  geomtools::vector_3d _standalone_constant_electric_field_;  //!< Standalone
                                                              //!uniform
                                                              //!electric field
