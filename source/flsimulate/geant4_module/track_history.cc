...
int track_history::track_info::get_id() const { return _id_; }
...
int track_history::track_info::get_parent_id() const { return _parent_id_; }
...
void track_history::track_info::set_creator_process_name(
    const std::string& name_) {
  _creator_process_name_ = name_;
}

const std::string& track_history::track_info::get_creator_sensitive_category()
    const {
  return _creator_sensitive_category_;
}

void track_history::track_info::set_creator_sensitive_category(
...
const track_history::track_info_dict_type& track_history::get_track_infos()
    const {
...
const track_history::track_info& track_history::get_track_info(
    const int id_) const {
